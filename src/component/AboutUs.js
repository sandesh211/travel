  ...
  useEffect(() => {
    ...
    return (
        <div>  <div class="header-margin"></div>
            <header className="header bg-white shadow-3 js-header" data-x="header" data-x-toggle="is-menu-opened">
                <div className="container">
                    <div className="row d-flex justify-between items-center">
                        <div className="col-auto">
                            <div className="d-flex items-center">
                                <a href="#" className="header-logo mr-30" data-x="header-logo" data-x-toggle="is-logo-dark">
                            ...
                            <div className="header-menu__content">
                                ...
                                <div className="menu js-navList d-flex justify-content-between">
                                    <ul className="menu__nav text-dark-1 -is-active text-center">
                                        ...
                                        <li><a href="Hotel"> Hotal</a></li>
                                        <li><a href="/Destination"> Destination</a></li>
                                        <li><a href="/Tpur"> Tour</a></li>
                        ...
                        <div className="col-auto">
                            <div className="d-flex items-center">
                                ...
                                <div className="d-flex ">
                                    ...
                                    <a href="#" className="button -outline-blue-1 px-30 fw-400 text-14 h-50 text-blue-1 ml-20">Sign In / Register</a>
                                </div>
                                <div className="d-none xl:d-flex x-gap-20 items-center pl-30" data-x="header-mobile-icons" data-x-toggle="text-white">
                                    <div><a href="login.html" className="d-flex items-center icon-user text-inherit text-22" /></div>
                                    <div><button className="d-flex items-center icon-menu text-inherit text-20" data-x-click="html, header, header-logo, header-mobile-icons, mobile-menu" /></div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div className="border-bottom-light pb-40">
      <div className="row y-gap-30 justify-center text-center">
        <div className="col-xl-3 col-6">
          <div className="text-40 lg:text-30 lh-13 fw-600">{destinations}</div>
          <div className="text-14 lh-14 text-light-1 mt-5">Destinations</div>
        </div>
        <div className="col-xl-3 col-6">
          <div className="text-40 lg:text-30 lh-13 fw-600">{properties}</div>
          <div className="text-14 lh-14 text-light-1 mt-5">Total Properties</div>
        </div>
        <div className="col-xl-3 col-6">
          <div className="text-40 lg:text-30 lh-13 fw-600">{customers}</div>
          <div className="text-14 lh-14 text-light-1 mt-5">Happy customers</div>
        </div>
        <div className="col-xl-3 col-6">
          <div className="text-40 lg:text-30 lh-13 fw-600">{volunteers}</div>
