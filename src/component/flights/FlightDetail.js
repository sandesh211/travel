...
const FlightDetail = (props) => {
  ...
  return (
    <div>
      <main>
        <section className="pt-30 layout-pb-md bg-light-2 pb-90">
          <div className="container">
            <div className="row y-gap-30">
              ...
              <div className="col-xl-9 col-lg-8">
                ...
                <div className="row">
                  <div className={`${LocationDataReturn ? "col-md-12 col-lg-6 single__list" : "singleflight"}`}>
                          ...
                          <Accordion.Item
                            ...
                            style={
                              LocationData && selectedFlight?.index === idx
                                ? { border: "solid rgb(31 184 229) 1px", background: "#f6fdff", boxShadow: "0 0 20px 0px #0000002b" }
                                : {}
                            }
                          >
                  ...
                  <div className={`${LocationDataReturn ? "col-md-12 col-lg-6 single__list" : ""}`}>
                    <div className="accordion__item base-tr returnflightbooking">
                    ...
                    {reviewResponse && (
                      <div className="additional-detail">
                        <div className="fixedbottom position-fixed bottom-0 bg-dark text-white">
                          <div className="container">
